...
if __name__ == "__main__":
    ...
    if test1_expected_output == test1_output:
        ...
        print("Failure!  Expected: ", test1_expected_output, "But got: ", test1_output)
    ...
    if test2_expected_output == test2_output:
        ...
        print("Failure!  Expected: ", test2_expected_output, "But got: ", test2_output)
    ...
    if test3_expected_output == test3_output:
        ...
        print("Failure!  Expected: ", test3_expected_output, "But got: ", test3_output)
